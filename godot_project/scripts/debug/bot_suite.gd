...
const SUITE_DEFAULTS: Dictionary = {
	"smoke": {
		...
		"runs_per_config": 1,
		"checklist": [
			"1.1.1", "1.1.2", "1.2.1", "1.2.3", "1.2.4", "3.3", "5.2",
			"2.4.2", "2.4.3", "4.3.12", "4.5.4", "4.9.1", "4.8.6", "4.8.2",
		],
	},
	"crash": {
		"character": "watcher",
		...
		"unlock_all": false,
		"runs_per_config": 1,
		"checklist": ["5.2", "3.3", "2.4.2", "4.3.12", "4.8.2"],
	},
	"full": {
		"character": "watcher",
		"difficulty": "lighthouse",
		...
		"runs_per_config": 1,
		"checklist": [
			"1.1.1", "1.1.2", "1.2.4", "3.3", "2.5.3", "4.10.1", "5.2",
			"2.4.2", "2.4.3", "4.3.12", "4.5.4", "4.9.1", "4.8.6", "4.8.2",
		],
	},
	"meta": {
		...
		"unlock_all": true,
		"runs_per_config": 1,
		"checklist": ["4.6.1", "4.6.3", "4.6.5", "4.8.1", "4.8.6", "4.8.2", "1.2.3", "4.3.12"],
	},
	"acceptance": {
		"character": "watcher",
		"difficulty": "lighthouse",
		...
		"runs_per_config": 2,
		"checklist": [
			"1.1.1", "1.1.2", "1.1.5", "1.2.1", "1.2.3", "1.2.4", "3.3", "5.2",
			"4.5.2", "4.5.3", "4.2.8", "2.5.3", "4.8.6", "4.8.2",
